			...
			for (SearchHit hit : searchHit) {
				...
				for (Map.Entry<String, Object> entry : map.entrySet()) {
					if (entry.getKey() == "parent_path") {
						parent_path = String.valueOf(entry.getValue());
					} else if (entry.getKey() == "directory_name") {
						directory_name = String.valueOf(entry.getValue());
						...
						size_bytes = String.valueOf(entry.getValue());
					} else if (entry.getKey() == "size") {
						size = (int) entry.getValue();
					} else if (entry.getKey() == "sync_time") {
						sync_time = String.valueOf(entry.getValue());
